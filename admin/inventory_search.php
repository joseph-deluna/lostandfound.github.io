                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                          <!-- Search bar -->
                            <form class="form-header" action="inventory_search.php" method="POST">
                              ...
                              <table class="table table-borderless table-striped table-earning">
                                  <thead>
                                      <tr>
                                          ...
                                          <th class="text-right">Surrendered By</th>
                                  ...
                                  <tbody>
                                    ...
                                    $sql = "SELECT * FROM items WHERE name LIKE '%$searchq%' OR description LIKE '%$searchq%'";
                                    ...
                                    if($result->num_rows > 0) {
                                      while($row = $result->fetch_assoc()) {
                                        ...
                                        <td>".$row['surrendered_by']."</td>
                                        <td>
                                        <a href='inventory_update.php?id=".$row['id']."'><button type='button' name='del'>Edit</button></a>
                                        <a href='inventory_delete.php?id=".$row['id']."'><button type='button'>Remove</button></a>
                                        </td>
                                        </tr>";
                                      }
                                    } else {
