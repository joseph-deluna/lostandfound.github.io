                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                          <!-- Search bar -->
                            <form class="form-header" action="search_result.php" method="POST">
                    ...
                    <div class="row">
                      ...
                      <div class="info-box-container">
                        <div class="info-box">
                          ...
                          <a class="small-box-footer" href="reports.php">Show all item</a>
                        </div>
                        <div class="info-box">
                          <div class="inner">
                            <h3>0 </h3><br>
                          ...
                          <a class="small-box-footer" href="inventory.php">Show all item</a>
                        </div>
                        <div class="info-box">
                          <div class="inner">
                            <h3>0</h3><br>
                          ...
                          <a class="small-box-footer" href="#">Show all item</a>
                        </div>
                      </div>
